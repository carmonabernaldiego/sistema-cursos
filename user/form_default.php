			...
			<div class="last">
				<div class="config-data-user">
					...
					<form action="" method="POST">
						<button class="btn-edit-info-user" name="btn" value="form_update" type="submit"><span class="icon">edit_note</span>Información Personal</button>
					</form>
					<form action="" method="POST">
						<button class="btn-change-pass" name="btn" value="form_update_pass" type="submit"><span class="icon">lock_open</span>Cambiar Contraseña</button>
					</form>
				</div>
			</div>
			<div class="footer">
